            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="controller_update.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-center align-items-center" style="margin-top: 10px;">
                                <input type="submit" class="btn btn-lg btnCreate text-white" value="Guardar Cambios" />
                                <a href="../inicio/index.php" class="btn btn-default btn-lg">Cancelar</a>

                                <!-- Botón para desactivar usuario -->
                                <input type="hidden" name="cambiar_estado" value="true" />
                                <button type="submit" class="btn btn-lg btn-danger" onclick="return confirm('¿Estás seguro de que deseas desactivar este usuario?');">
                                    Eliminar usuario
                                </button>
                            </div>
                        </div>
